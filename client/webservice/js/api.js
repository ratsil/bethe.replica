	...
	return {
		...
		Authorize: function(fCallback) {
			Request.Send('authorize', function(oResponse) {
				...
				if (!(API.oUser = oResponse.oValue)) {
					// ---------------------------------- надо поменять этй строчку на просто "/"
					console.log('авторизация всё!');
					window.location.go('/newreplicalogin.html');
					return;
				}
				if (oResponse.oValue.ClassName) {
					console.log('авторизация всё!');
					window.location.go('/newreplicalogin.html');
					return;
				}
				if (fCallback) {
					if (true === oResponse.oValue)
						fCallback();
				}
			});
		},
		...
		MAM: {
			Assets: {
				List: function(sVideoTypeFilter, fCallback) {
					if (!fCallback)
						return;
					Request.Send('AssetsGet', [sVideoTypeFilter], false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				ParametersToPlaylistSave: function(id, fCallback) {
					Request.Send('AssetParametersToPlaylistSave',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				VideoTypeGet: function(id, fCallback) {
					Request.Send('AssetVideoTypeGet', JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				AssetVideoTypeChange: function(id, idVideoTypes, fCallback) {
					Request.Send('AssetVideoTypeChange',  JSON.stringify({ data: [id, idVideoTypes], types: ['System.Int64', 'System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
			...
			Programs: {
				...
				Get: function(id, fCallback) {
					if (!fCallback)
						return;
					Request.Send('ProgramGet', JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Save: function(o, fCallback) {
					Request.Send('ProgramSave', JSON.stringify({ data: [o], types: ['helpers.replica.mam.Program, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Clips: {
				...
				Get: function(id, fCallback) {
					if (!fCallback)
						return;
					Request.Send('ClipGet', JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Save: function(o, fCallback) {
					Request.Send('ClipSave', JSON.stringify({ data: [o], types: ['helpers.replica.mam.Clip, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Advertisements: {
				...
				Get: function(id, fCallback) {
					if (!fCallback)
						return;
					Request.Send('AdvertisementGet', JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Save: function(o, fCallback) {
					Request.Send('AdvertisementSave', JSON.stringify({ data: [o], types: ['helpers.replica.mam.Advertisement, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Designs: {
				...
				Get: function(id, fCallback) {
					if (!fCallback)
						return;
					Request.Send('DesignGet',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Save: function(o, fCallback) {
					Request.Send('DesignSave', JSON.stringify({ data: [o], types: ['helpers.replica.mam.Design, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			ChatInOuts: {
				List: function(oAsset, fCallback) {
					if (!oAsset)
						return fCallback ? fCallback() : null;
					Request.Send('ChatInOutsGet', JSON.stringify({ data: [oAsset], types: ['helpers.replica.mam.Asset, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Save: function(oAsset, a, fCallback) {
					if (!oAsset)
						return fCallback ? fCallback() : null;
					Request.Send('ChatInOutsSave', JSON.stringify({ data: [oAsset, a], types: ['helpers.replica.mam.Asset, helpers.replica', 'helpers.replica.cues.ChatInOut[], helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			VideoTypes: {
				...
				Get: function(sType, fCallback) {
					Request.Send('VideoTypeGet', JSON.stringify({ data: [sType], types: ['System.String'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Persons: {
				Artists: {
					...
					Load: function(idAssets, fCallback) {
						if (!fCallback)
							return;
						Request.Send('ArtistsLoad', JSON.stringify({ data: [idAssets], types: ['System.Int64'] }), false, function(oResponse) {
							if (!_ResponseCheck(oResponse))
								return console.log(JSON.stringify(oResponse));
							fCallback(oResponse.oValue || []);
						});
					...
					CueNameGet: function(aPersonIDs, fCallback) {
						if (!aPersonIDs)
							return fCallback ? fCallback() : null;
						Request.Send('ArtistsCueNameGet', JSON.stringify({ data: [aPersonIDs], types: ['webservice.services.DBInteract.MyInt[]'] }), false, function(oResponse) {
							if (!_ResponseCheck(oResponse))
								return console.log(JSON.stringify(oResponse));
							if (fCallback)
								fCallback(oResponse.oValue || []);
				...
				List: function(sPersonTypeFilter, fCallback) {
					if (!fCallback)
						return;
					Request.Send('PersonsGet', JSON.stringify({ data: [sPersonTypeFilter], types: ['System.String'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				TypeGet: function(sPersonTypeFilter, fCallback) {
					if (!fCallback)
						return;
					Request.Send('PersonTypeGet', JSON.stringify({ data: [sPersonTypeFilter], types: ['System.String'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Save: function(o, fCallback) {
					if (!o)
						return fCallback ? fCallback() : null;
					Request.Send('PersonSave', JSON.stringify({ data: [o], types: ['helpers.replica.mam.Person, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Styles: {
				...
				Load: function(idAssets, fCallback) {
					if (!fCallback)
						return;
					Request.Send('StylesLoad', JSON.stringify({ data: [idAssets], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
			...
			Customs: {
				Load: function(idAssets, fCallback) {
					if (!fCallback)
						return;
					Request.Send('CustomsLoad', JSON.stringify({ data: [idAssets], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Set: function(aAssets, fCallback) {
					if (!aAssets || !aAssets.length)
						return fCallback ? fCallback() : null;
					Request.Send('CustomsLoad', JSON.stringify({ data: [aAssets], types: ['helpers.replica.mam.Asset[], helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
			...
			FilesAge: {
				Get: function(oAsset, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FilesAgeGet', JSON.stringify({ data: [oAsset], types: ['helpers.replica.mam.Asset, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				Set: function(oAsset, nAge, fCallback) {
					if (!oAsset)
						return fCallback ? fCallback() : null;
					Request.Send('FilesAgeSet', JSON.stringify({ data: [oAsset, nAge], types: ['helpers.replica.mam.Asset, helpers.replica', 'System.Int'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
		...
		Media: {
			...
			Files: {
				List: function(idStorages, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FilesGet', JSON.stringify({ data: [idStorages], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				WithSourcesGet: function(idStorages, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FilesWithSourcesGet', JSON.stringify({ data: [idStorages], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				AdditionalInfoGet: function(oFile, oRTStrings, oRTAssets, oRTDates, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FileAdditionalInfoGet', JSON.stringify({ data: [oFile, oRTStrings, oRTAssets, oRTDates], types: ['helpers.replica.media.File, helpers.replica', 'helpers.replica.hk.RegisteredTable, helpers.replica', 'helpers.replica.hk.RegisteredTable, helpers.replica', 'helpers.replica.hk.RegisteredTable, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				IsInPlaylist: function(id, nMinutes, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FileCheckIsInPlaylist', JSON.stringify({ data: [id, nMinutes], types: ['System.Int64', 'System.Int'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				DurationQuery: function(id, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FileDurationQuery',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				CommandStatusGet: function(idCommandsQueue, fCallback) {
					if (!fCallback)
						return;
					Request.Send('CommandStatusGet', JSON.stringify({ data: [idCommandsQueue], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				FramesQtyGet: function(idCommandsQueue, fCallback) {
					if (!fCallback)
						return;
					Request.Send('FramesQtyGet', JSON.stringify({ data: [idCommandsQueue], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				IDsInStockGet: function(a, fCallback) {
					...
					if (!a || !a.length)
						return fCallback ? fCallback() : null;
					Request.Send('FileIDsInStockGet', JSON.stringify({ data: [a], types: ['System.Int64[]'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Remove: function(a, fCallback) {
					if (!a || !a.length)
						return fCallback ? fCallback() : null;
					Request.Send('FilesRemove', JSON.stringify({ data: [a], types: ['System.Int64[]'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
		...
		Ingest: {
			TSRItemsGet: function(aFilenames, fCallback) {
				if (!fCallback)
					return;
				Request.Send('TSRItemsGet', JSON.stringify({ data: [aFilenames], types: ['System.String[]'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			IsThereSameFile: function(sFilename, fCallback) {
				if (!fCallback)
					return;
				Request.Send('IsThereSameFile', JSON.stringify({ data: [sFilename], types: ['System.String'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue);
				});
			...
			AreThereSameFiles: function(aFilenames, fCallback) {
				if (!fCallback)
					return;
				Request.Send('AreThereSameFiles', JSON.stringify({ data: [aFilenames], types: ['System.String[]'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			IsThereSameCustomValue: function(sName, sValue, fCallback) {
				if (!fCallback)
					return;
				Request.Send('IsThereSameCustomValue', JSON.stringify({ data: [sName, sValue], types: ['System.String', 'System.String'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue);
				});
			...
			AreThereSameCustomValues: function(sName, aValues, fCallback) {
				if (!fCallback)
					return;
				Request.Send('IsThereSameCustomValues', JSON.stringify({ data: [sName, aValues], types: ['System.String', 'System.String[]'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			IngestForReplacedFile: function(oFile, fCallback) {
				Request.Send('IngestForReplacedFile', JSON.stringify({ data: [oFile], types: ['helpers.replica.media.File, helpers.replica'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					if (fCallback)
						fCallback(oResponse.oValue);
			...
			Ingest: function(oInfo, fCallback) {
				Request.Send('Ingest', JSON.stringify({ data: [oInfo], types: ['helpers.replica.media.File.Ingest, helpers.replica'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					if (fCallback)
						fCallback(oResponse.oValue);
		...
		PL: {
			Items: {
				...
				DeleteSince: function(dtBegin, fCallback) {
					Request.Send('PlaylistItemsDeleteSince', JSON.stringify({ data: [dtBegin], types: ['System.DateTime'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Advance: {
				...
				List: function(dtBegin, dtEnd, fCallback) {
					if (!fCallback)
						return;
					Request.Send('AdvancedPlaylistsGet', JSON.stringify({ data: [dtBegin, dtEnd], types: ['System.DateTime', 'System.DateTime'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Get: function(o, fCallback) {
					...
					if (!o)
						return fCallback();
					Request.Send('AdvancedPlaylistGet', JSON.stringify({ data: [o], types: ['helpers.replica.cues.plugins.Playlist, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				AddReplace: function(o, fCallback) {
					Request.Send('AdvancedPlaylistAddReplace', JSON.stringify({ data: [o], types: ['helpers.replica.cues.plugins.Playlist, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Start: function(o, fCallback) {
					if (!o)
						return fCallback ? fCallback() : null;
					Request.Send('AdvancedPlaylistStart', JSON.stringify({ data: [o], types: ['helpers.replica.cues.plugins.Playlist, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Rename: function(o, fCallback) {
					if (!o)
						return fCallback ? fCallback() : null;
					Request.Send('AdvancedPlaylistRename', JSON.stringify({ data: [o], types: ['helpers.replica.cues.plugins.Playlist, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Delete: function(o, fCallback) {
					if (!o)
						return fCallback ? fCallback() : null;
					Request.Send('AdvancedPlaylistDelete', JSON.stringify({ data: [o], types: ['helpers.replica.cues.plugins.Playlist, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			Import: {
				ImportLogGet: function(fCallback) {
					if (!fCallback)
						return;
			...
			BeforeAddCheckRange: function(dtBegin, dtEnd, fCallback) {
				if (!fCallback)
					return;
				Request.Send('BeforeAddCheckRange', JSON.stringify({ data: [dtBegin, dtEnd], types: ['System.DateTime', 'System.DateTime'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue);
				});
			...
			PLICurrentSkip: function(id, fCallback) {
				if (!id)
					return fCallback ? fCallback() : null;
				Request.Send('PLICurrentSkip',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					if (fCallback)
						fCallback();
		...
		Templates: {
				...
				Texts: {
					List: function(aMessages, fCallback) {
						...
						if (!aMessages || !aMessages.length)
							return fCallback();
						Request.Send('TemplateMessagesTextGet', JSON.stringify({ data: [aMessages], types: ['helpers.replica.cues.Template[], helpers.replica'] }), false, function(oResponse) {
							if (!_ResponseCheck(oResponse))
								return console.log(JSON.stringify(oResponse));
							fCallback(oResponse.oValue || []);
						});
					...
					Save: function(aDict, fCallback) {
						if (!aDict || !aDict.length)
							return fCallback ? fCallback() : null;
						Request.Send('TemplateMessagesTextSave', JSON.stringify({ data: [aDict], types: ['helpers.replica.cues.DictionaryElement[], helpers.replica'] }), false, function(oResponse) {
							if (!_ResponseCheck(oResponse))
								return console.log(JSON.stringify(oResponse));
							if (fCallback)
								fCallback(oResponse.oValue);
			...
			Schedule: {
				List: function(aTemplateBinds, dtBegin, fCallback) {
					...
					if (!aTemplateBinds || !aTemplateBinds.length)
						return fCallback();
					Request.Send('TemplatesScheduleGet', JSON.stringify({ data: [aTemplateBinds, dtBegin], types: ['helpers.replica.cues.TemplateBind[], helpers.replica', 'System.DateTime'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Add: function(aTemplatesSchedule, fCallback) {
					if (!aTemplatesSchedule || !aTemplatesSchedule.length)
						return fCallback ? fCallback() : null;
					Request.Send('TemplatesScheduleAdd', JSON.stringify({ data: [aTemplatesSchedule], types: ['helpers.replica.cues.TemplatesSchedule[], helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Delete: function(aTemplatesSchedule, fCallback) {
					if (!aTemplatesSchedule || !aTemplatesSchedule.length)
						return fCallback ? fCallback() : null;
					Request.Send('TemplatesScheduleDelete', JSON.stringify({ data: [aTemplatesSchedule], types: ['helpers.replica.cues.TemplatesSchedule[], helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			DirectoriesTrailsGet: function(sPath, fCallback) {
				if (!fCallback)
					return;
				Request.Send('DirectoriesTrailsGet', JSON.stringify({ data: [sPath], types: ['System.String'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
		...
		SCR: {
			...
			Messages: {
				...
				Mark: function(id, fCallback) {
					if (null == id)
						return fCallback ? fCallback() : null;
					Request.Send('MessageMark',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
				...
				UnMark: function(id, fCallback) {
					if (null == id)
						return fCallback ? fCallback() : null;
					Request.Send('MessageUnMark',  JSON.stringify({ data: [id], types: ['System.Int64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback();
			...
			Plaques: {
				List: function(oPreset, fCallback) {
					if (!fCallback)
						return;
					Request.Send('PlaquesGet', JSON.stringify({ data: [oPreset], types: ['helpers.IdNamePair, helpers.common'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue || []);
					});
				...
				Add: function(oPlaque, fCallback) {
					if (!oPlaque)
						return fCallback ? fCallback() : null;
					Request.Send('PlaqueAdd', JSON.stringify({ data: [oPlaque], types: ['helpers.replica.scr.Plaque, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Change: function(oPlaque, fCallback) {
					if (!oPlaque)
						return fCallback ? fCallback() : null;
					Request.Send('PlaqueChange', JSON.stringify({ data: [oPlaque], types: ['helpers.replica.scr.Plaque, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
				...
				Delete: function(oPlaque, fCallback) {
					if (!oPlaque)
						return fCallback ? fCallback() : null;
					Request.Send('PlaqueDelete', JSON.stringify({ data: [oPlaque], types: ['helpers.replica.scr.Plaque, helpers.replica'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						if (fCallback)
							fCallback(oResponse.oValue);
			...
			TimeBlockGet: function(dt, bForward, fCallback) {
				if (!fCallback)
					return;
				Request.Send('TimeBlockGet', JSON.stringify({ data: [dt, bForward], types: ['System.DateTime', 'System.Boolean'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			CuesGet: function(idAssets, fCallback) {
				if (!fCallback)
					return;
				Request.Send('CuesGet', JSON.stringify({ data: [idAssets], types: ['System.Int64'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue);
				});
			...
			LogoBindingGet: function(aPLIs, fCallback) {
				if (!fCallback)
					return;
				Request.Send('LogoBindingGet', JSON.stringify({ data: [aPLIs], types: ['helpers.replica.pl.PlaylistItem[],helpers.replica.pl'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			PLFragmentGet: function(dtBegin, dtEnd, fCallback) {
				if (!fCallback)
					return;
				Request.Send('PLFragmentGet', JSON.stringify({ data: [dtBegin, dtEnd], types: ['System.DateTime', 'System.DateTime'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
		...
		Stat: {
			Export: {
				ResultGet: function(nWorkerInfoID, fCallback) {
					...
					if (null == nWorkerInfoID)
						return fCallback();
					Request.Send('ExportResultGet', JSON.stringify({ data: [nWorkerInfoID], types: ['System.UInt64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
				...
				WorkerProgressGet: function(nWorkerInfoID, fCallback) {
					...
					if (null == nWorkerInfoID)
						return fCallback();
					Request.Send('WorkerProgressGet', JSON.stringify({ data: [nWorkerInfoID], types: ['System.UInt64'] }), false, function(oResponse) {
						if (!_ResponseCheck(oResponse))
							return console.log(JSON.stringify(oResponse));
						fCallback(oResponse.oValue);
					});
			...
			Get: function(oFilters, fCallback) {
				if (!fCallback)
					return;
				Request.Send('StatGet', JSON.stringify({ data: [oFilters], types: ['webservice.services.DBInteract.DBFilters'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
			...
			MessagesGet: function(oFilters, fCallback) {
				if (!fCallback)
					return;
				Request.Send('MessagesGet', JSON.stringify({ data: [oFilters], types: ['webservice.services.DBInteract.DBFilters'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
		...
		UI: {
			FrequencyOfOccurrence: function(idVideoTypes, fCallback) {
				if (!fCallback)
					return;
				Request.Send('FrequencyOfOccurrence', JSON.stringify({ data: [idVideoTypes], types: ['System.Int64'] }), false, function(oResponse) {
					if (!_ResponseCheck(oResponse))
						return console.log(JSON.stringify(oResponse));
					fCallback(oResponse.oValue || []);
				});
