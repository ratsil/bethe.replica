...
function getDuration(nDuration) {
    let ee = nDuration / 25 / 60;
    let minutes = Math.floor(ee);
    let second = (10 <= (Math.floor(60 * (ee - minutes)))) ? Math.floor(60 * (ee - minutes)) : "0" + Math.floor(60 * (ee - minutes));
    let frames = nDuration % 25;
    let sDuration = minutes + ":" + second + ' .' + frames;
